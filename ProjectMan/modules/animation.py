...
async def zeyenk(client: Client, message: Message):
    e = await edit_or_reply(message, "Wuff yuu ❤️")
    await e.edit("noni bau")
    await e.edit("💞💕💗💘")
    await e.edit("jarang mandi")
    await e.edit("bau betul")
    await e.edit("ayang")
    await e.edit("aku")
    await e.edit("SAYANG KAMU 💝💖💘")
    await e.edit("tapi")
    await e.edit("ayang bau")
    await e.edit("💘💞💕💗")
    await e.edit("SAYANG")
    await e.edit("KAMU")
    await e.edit("ayang bau")
    await e.edit("baubau")
    await e.edit("bau ajab")
    await e.edit("noni bau")
    await e.edit("ayang aku bau")
    await e.edit("gaperna mandi")
    await e.edit("tp aku sayang")
    await e.edit("maupun bau")
    await e.edit("😗😗")
    await e.edit("😙")
    await e.edit("NONI BAUUU")
