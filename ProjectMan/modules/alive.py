...
@Client.on_message(filters.command(["alive", "dz"], cmd) & filters.me)
async def alive(client: Client, message: Message):
    ...
    man = (
        f"<b>{alive_text}</b>\n\n"
        f"{emoji} <b>×_× :</b> {client.me.mention} \n"
        ...
        f"    **[Base Repo](https://github.com/mrismanaziz/PyroMan-Userbot})** | **[DzL](https://t.me/{CHANNEL})** | **[huh](tg://user?id={client.me.id})**"
    )
    try:
